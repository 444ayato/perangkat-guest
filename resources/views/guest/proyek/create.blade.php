      ...
      <form action="{{ route('proyek.store') }}" method="POST">
        ...
        <div class="row">
          <div class="col-md-4 mb-3">
            ...
            <input type="text" name="kode_proyek" value="{{ old('kode_proyek') }}" class="form-control" required>
          </div>
          <div class="col-md-4 mb-3">
            <label class="form-label">Nama Proyek</label>
            <input type="text" name="nama_proyek" value="{{ old('nama_proyek') }}" class="form-control" required>
          </div>
          <div class="col-md-4 mb-3">
